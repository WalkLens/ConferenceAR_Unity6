...
namespace MRTK.Tutorials.MultiUserCapabilities
{
    public class PhotonLobbyConferenceAR : MonoBehaviourPunCallbacks
    {
        ...
        {
            /*PhotonNetwork.PhotonServerSettings.AppSettings.FixedRegion = "kr"; // 한국 서버로 고정
            PhotonNetwork.ConnectUsingSettings();
            FileLogger.Log($"Photon Server Settings | Region: {PhotonNetwork.CloudRegion} | GameVersion: {PhotonNetwork.GameVersion}");
            */
        ...
        private void StartNetwork()
        {
            ...
            PhotonNetwork.ConnectUsingSettings();
            Lobby = this;
            FileLogger.Log($"✅ Connected to Photon Server | Region: {PhotonNetwork.CloudRegion} | GameVersion: {PhotonNetwork.GameVersion}");
        }
